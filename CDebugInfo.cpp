...
void CDebugInfo::Draw()
{
	...
	if (m_uiDrawDebug || m_uiDrawFPS)
	{
		...
		pos = ImVec2(pGUI->ScaleX(1900.0f - ImGui::CalcTextSize(&szStr[0]).x), pGUI->ScaleY(1080.0f - pGUI->GetFontSize()));

		pGUI->RenderText(pos, (ImU32)0xBEBEBEFF, true, &szStr[0]);
	}
	...
	pos = ImVec2(pGUI->ScaleX(1230.0f), pGUI->ScaleY(1080.0f - pGUI->GetFontSize()));
